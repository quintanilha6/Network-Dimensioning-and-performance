...
GlobalBest = struct('w', Inf, 'MaximumLoad', Inf);
...
while counter < 500
    ...
    while repeat
        ...
        for i=1:size(CurrentSolution.routes,1)
            ...
            if NeighbourObjective.MaximumLoad < NeighbourBest.MaximumLoad || (NeighbourObjective.MaximumLoad == NeighbourBest.MaximumLoad && NeighbourObjective.w < NeighbourBest.w)
                NeighbourBest = NeighbourObjective;
                NeighbourBestSolution= NeighbourSolution;
            end
        end
        
        if NeighbourBest.MaximumLoad < CurrentObjective.MaximumLoad || (NeighbourBest.MaximumLoad == CurrentObjective.MaximumLoad  &&  NeighbourBest.w < CurrentObjective.w)
    ...
    if CurrentObjective.MaximumLoad < GlobalBest.MaximumLoad || (CurrentObjective.MaximumLoad == GlobalBest.MaximumLoad && CurrentObjective.w < GlobalBest.w)
        ...
        fprintf('GlobalBest MaximumLoad = %.9f\n\n', GlobalBest.MaximumLoad)
